    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <select id="role" name="role" class="block mt-1 w-full rounded-md shadow-sm border-gray-300 focus:border-indigo-500 focus:ring-indigo-500" required>
                ...
                <option value="buyer" {{ old('role') == 'buyer' ? 'selected' : '' }}>Buyer (I want to buy services)</option>
                <option value="seller" {{ old('role') == 'seller' ? 'selected' : '' }}>Seller (I want to sell services)</option>
            </select>
